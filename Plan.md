...
3. ~~Реалізувати додавання елементів до БД(БД має бути з полями id, name(String), calendarDate(format int[]), frequency(не повторювати, повторювати кожний день, кожний тиждень...)~~
...
6. Зробити показ calendarDate/time pickers, на [add_note.xml] через EditText, а не через TextView
